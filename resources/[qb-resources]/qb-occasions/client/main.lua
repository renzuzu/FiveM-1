                ...
                if sellDist <= 13.0 and IsPedInAnyVehicle(ped) then 
                    ...
                    if sellDist <= 3.5 and IsPedInAnyVehicle(ped) then
                        ...
                        if IsControlJustPressed(0, Keys["E"]) then
                            ...
                            QBCore.Functions.TriggerCallback('qb-occasions:server:checkVehicleOwner', function(owned)
                                if owned then
                                    openSellContract(true)
                                else
                                    QBCore.Functions.Notify('This vehicle does not belong to you or has outstanding finance payments owed.', 'error', 3500)
                                end
                            end, VehiclePlate)
                        end
                    end
